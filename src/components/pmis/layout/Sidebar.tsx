        ...
        <div className="mt-auto border-t border-gray-200 py-4 px-4 space-y-5">
          <div>
            ...
            <div className="space-y-1">
              ...
              <button className="w-full text-left text-secondary text-gray-600 hover:bg-[#f6f8fc] hover:text-blue-600 py-1.5 px-2 rounded transition-colors truncate">Thông tin sự cố</button>
