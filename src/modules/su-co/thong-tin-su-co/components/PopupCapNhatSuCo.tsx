            ...
            <div className="space-y-1">
              ...
              {isView ? (
                <input 
                  ...
                  readOnly={true}
                  className="w-full px-3 py-2 text-[12pt] rounded-lg transition-all bg-transparent border-transparent focus:outline-none"
                />
              ) : (
                <select 
                  className="w-full px-3 py-2 text-[12pt] rounded-lg transition-all bg-white border border-gray-200 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 appearance-none"
                  defaultValue={detailForm.data?.device || ""}
                >
